...
window.addEventListener('DOMContentLoaded', function () {
  ...
  function newsStandFunc() {
    ...
    const newsArrowBox = document.getElementById('newsArrowBox');
    const newsPrevBt = document.getElementById('newsPrevBt');
    const newsNextBt = document.getElementById('newsNextBt');
    const arrowBt = document.getElementsByClassName('arrow_ab_box');
    const newsStandView = document.getElementById('newsStandView');
    ...
    function newsPageFunc(p) {
      ...
      for (var cnt = 0; cnt < 18; cnt++) {
        let newsData = newsStandData[pageNum].newsStandPage[cnt];
