...
gulp.task('uglifyCss', function () {
  gulp.src([dist + '/css/*.css',dist + '/css/base/*.css', dist + '/css/component/*.css',dist + '/css/modules/*.css'])
    .pipe(uglifyCss())
...
gulp.task('sassindex', function () {
  gulp.src(src+'/sass/component/index.scss')
    .pipe(sass())
    .pipe(gulp.dest(dist + '/css/component'))
});

// image compress
gulp.task('imagecom', function () {
...
gulp.task('default', ['babel', 'combine-js', 'compress-js','imagecom', 'sass','sassindex', 'uglifyCss', 'minifyHtml']);
